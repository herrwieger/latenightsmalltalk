...
public class SimpleSmalltalkSourceViewerConfiguration extends SmalltalkSourceViewerConfiguration {

    private boolean fConfigureFormatter;

    public SimpleSmalltalkSourceViewerConfiguration(IColorManager colorManager, IPreferenceStore preferenceStore,
